...
export default function Boards() {
  ...
  const boards = [
    ...
    {name: 'Paulus Nurwandono', position: 'President Director', photo: paulusN},
  ...
  const desc = [
    ...
    'Paulus adalah seorang eksekutif senior dengan karir yang panjang di sektor real estate dan perbankan di Indonesia. Paulus adalah CEO PT Urban Jakarta Propertindo, pengembang terdaftar Indonesia yang berfokus pada pengembangan berorientasi transportasi di Jakarta. Paulus menjabat sebagai Presiden Komisaris PT Bank Agris Tbk sejak tahun 2012 Bank Agris diakuisisi oleh Industrial Bank of Korea pada tahun 2019 dan Paulus terus memimpin Dewan Komisaris. Paulus memiliki rekam jejak yang panjang dari posisi manajemen senior di lembaga keuangan terkemuka di Indonesia seperti PT Prospera Asset Management, PT Sarana Multigriya Financial, dan PT Mandiri Sekuritas',

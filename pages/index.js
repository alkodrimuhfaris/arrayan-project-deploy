...
import Award1 from '../Assets/Icons/awards-1.svg';
import Award2 from '../Assets/Icons/awards-2.svg';
import Award3 from '../Assets/Icons/awards-3.svg';
import Award4 from '../Assets/Icons/awards-4.svg';
            ...
            <div className="container pt-0 pt-md-5 pt-lg-0 mt-0 mt-md-5 mt-lg-0">
              <section className="col-12 col-md-12 col-lg-6">
                ...
                <p className="subtitle">
                  ...
                  cost housing located in Bekasi, Karawang & Purwakarta Region.
                </p>
        ...
        >
          <section className="container">
            ...
            <p className="subtitle mx-auto text-grey">
              ...
              apa pendapat orang yang sudah memiliki property di Arrayan Group.
            </p>
          </section>
          <div className="">
            <section
                ...
                >
                  <div
                    ...
                    style={{
                      width: md
                        ? refTestiWrapper.current && refTestiIndv.current
                          ? `${refTestiIndv.current.offsetWidth / 2}px`
                          : '0%'
                        : '0%',
                    }}
                  />
                    ...
                    {testimonyList.map((val, idx) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            left: md
                              ? `${widthRefTesti / 2 + idx * widthRefTesti}px`
        ...
        >
          <section className="container text-center">
            ...
            <p className="subtitle w-80 my-4 mx-auto">
              ...
              sini, karenanya tim Arrayan Group selalu siap untuk membantu Anda
